...
public class ItemDatabase {
    ...
    static {
        ...
        items.put(2, new Item(2,"BK Fries",3,"Classic Salted Fries",R.drawable.fries));
        items.put(3, new Item(3,"BK Wings", 7,"10 BK Hot Wings",R.drawable.wings));
        items.put(4, new Item(4,"BK Nuggets", 4,"Golden BK Nuggets with Sauce",R.drawable.nuggets));
        ...
        items.put(7, new Item(7,"BK Chicken Salad", 4,"Fresh Chicken Salad for those seeking a healthy alternative!",R.drawable.salad));
        ...
        items.put(13, new Item(13,"Sparkling Water",4,"Premium Sparkling Water with Ice",R.drawable.water));
